...
class RegularInstanceMetadata {
  ...
  @JsonProperty("module-name") var moduleName: String = null
  @Property("module-version")
  @JsonProperty("module-version") var moduleVersion: String = null
  var status: String = null
  @Id var name: String = null
  var description: String = null
  var inputs: Array[String] = null
  var outputs: Array[String] = null
  @Property("checkpoint-mode")
  @JsonProperty("checkpoint-mode") var checkpointMode: String = null
  @Property("checkpoint-interval")
  ...
  @Property("state-full-checkpoint")
  ...
  @Property("per-task-cores")
  @JsonProperty("per-task-cores") var perTaskCores: Int = 0
  @Property("per-task-ram")
  @JsonProperty("per-task-ram") var perTaskRam: Int = 0
  @Embedded(value = "jvm-options")
  @JsonProperty("jvm-options") var jvmOptions: HashMap[String, Any] = null
  @Embedded(value = "execution-plan")
