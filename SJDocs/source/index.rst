...
The documentation presented here is for SJ-Platform Release 1.1.1. It gives a complete understanding of the platform, its components, basic features fulfilled in it. A detailed Tutorial_ provides a real-life example task  resolved with SJ-Platform as well as detailed platform deployment instructions. A custom module development guide explains how to write a module using a simple hello-world example. The guides for the Web UI and the CRUD REST API may be of utmost importance for platform administrators. 
