...
export class ProjectConfig extends SeedConfig {
  ...
  constructor() {
    ...
    this.mergeObject(this.PLUGIN_CONFIGS['browser-sync'], {
      middleware: [
        proxy({
          hostname: process.env.API_BACKEND_HOST,  // process.env.API_BACKEND_HOST, 176.120.25.19:28080  192.168.1.174:18080 192.168.1.225:8880 192.168.1.174:28080
          port: process.env.API_BACKEND_PORT, // port: process.env.API_BACKEND_PORT
          pathname: '/v1',
          route: '/v1'
        }),
