...
import com.bwsw.sj.common.DAL.model.module.{Instance, Task, WindowedInstance}
...
object DataFactory {
  ...
  private val kafkaProviderName = "windowed-kafka-test-provider"
  private val cassandraProviderName = "windowed-cassandra-test-provider"
  private val zookeeperProviderName = "windowed-zookeeper-test-provider"
  private val tstreamServiceName = "windowed-tstream-test-service"
  private val cassandraServiceName = "windowed-cassandra-test-service"
  private val kafkaServiceName = "windowed-kafka-test-service"
  private val zookeeperServiceName = "windowed-zookeeper-test-service"
