...
import com.bwsw.sj.common._dal.morphia.MorphiaAnnotations.{EmbeddedField, IdField, PropertyField}
...
/**
  ...
  */
@Entity("instances")
class Instance(@IdField val name: String,
               ...
               val engine: String,
               @EmbeddedField("coordination-service") val coordinationService: ZKService,
