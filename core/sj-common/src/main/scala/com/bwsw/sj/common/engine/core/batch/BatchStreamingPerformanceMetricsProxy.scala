...
/**
  * Handles data for [[BatchStreamingPerformanceMetrics]] in separate thread
  *
  * @author Pavel Tomskikh
  */
class BatchStreamingPerformanceMetricsProxy(performanceMetrics: BatchStreamingPerformanceMetrics, threadName: String)
...
object BatchStreamingPerformanceMetricsProxy {
