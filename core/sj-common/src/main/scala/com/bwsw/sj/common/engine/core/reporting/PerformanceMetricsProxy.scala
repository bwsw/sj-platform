...
/**
  * Handles data for [[PerformanceMetrics]] in separate thread
  *
  * @author Pavel Tomskikh
  */
class PerformanceMetricsProxy(performanceMetrics: PerformanceMetrics, threadName: String) extends Callable[Unit] {

  import PerformanceMetricsProxy._
...
object PerformanceMetricsProxy {

  trait Message

  case class InputEnvelope(envelope: Envelope) extends Message
