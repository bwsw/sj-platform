...
case class ConfigurationSettingApi(name: String, value: String, domain:String) {
  @JsonIgnore
  def asModelConfigurationSetting: ConfigurationSettingDomain = {
    val configurationSetting = new ConfigurationSettingDomain(
