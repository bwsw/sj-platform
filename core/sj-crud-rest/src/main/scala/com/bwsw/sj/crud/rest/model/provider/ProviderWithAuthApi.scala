...
import com.bwsw.sj.common.si.model.provider.ProviderWithAuth
import com.bwsw.sj.common.utils.RestLiterals
import com.fasterxml.jackson.annotation.{JsonIgnore, JsonProperty}
import scaldi.Injector


class ProviderWithAuthApi(name: String,
                          val login: String,
                          val password: String,
  ...
  @JsonIgnore
  override def to()(implicit injector: Injector): ProviderWithAuth = {
