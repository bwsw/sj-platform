...
class DecimalField(name: String, default: java.math.BigDecimal = java.math.BigDecimal.ZERO) extends JdbcField[java.math.BigDecimal](name, default) {
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.math.BigDecimal.")
  }
}
...
class DateField(name: String, default: java.sql.Date = new java.sql.Date(0L)) extends JdbcField[java.sql.Date](name, default) {
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.sql.Date.")
  }
}
...
class BinaryField(name: String, default: Array[Byte] = new Array[Byte](0)) extends JdbcField[Array[Byte]](name, default) {
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Array[Byte].")
  }
}
...
class JavaStringField(name: String, default: java.lang.String = "") extends JdbcField[java.lang.String](name, default) {
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case _ => (ps: PreparedStatement, idx: Int) => ps.setString(idx, s"${StringEscapeUtils.escapeJava(o.toString)}")
  }
}
...
class HTMLStringField(name: String, default: java.lang.String = "") extends JdbcField[java.lang.String](name, default) {
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case _ => (ps: PreparedStatement, idx: Int) => ps.setString(idx, StringEscapeUtils.escapeHtml4(o.toString))
  }
}
