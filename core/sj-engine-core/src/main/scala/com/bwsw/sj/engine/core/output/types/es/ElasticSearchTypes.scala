...
class IntegerField(name: String, default: java.lang.Integer = 0) extends ElasticsearchField[java.lang.Integer](name, default) {
  override def transform(o: AnyRef): String = o match {
    case null => "null"
    case i: java.lang.Integer => i.toString
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Integer.")
  }
}
...
class LongField(name: String, default: java.lang.Long = 0L) extends ElasticsearchField[java.lang.Long](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Long.")
  }
}
...
class FloatField(name: String, default: java.lang.Float = 0.0f) extends ElasticsearchField[java.lang.Float](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Float.")
  }
}
...
class DoubleField(name: String, default: java.lang.Double = 0.0) extends ElasticsearchField[java.lang.Double](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Double.")
  }
}
...
class ByteField(name: String, default: java.lang.Byte = 0.toByte) extends ElasticsearchField[java.lang.Byte](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Byte.")
  }
}
...
class CharField(name: String, default: java.lang.Character = 0.toChar) extends ElasticsearchField[java.lang.Character](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Character.")
  }
}
...
class ShortField(name: String, default: java.lang.Short = 0.toShort) extends ElasticsearchField[java.lang.Short](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Short.")
  }
}
...
class BooleanField(name: String, default: java.lang.Boolean = true) extends ElasticsearchField[java.lang.Boolean](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.Boolean.")
  }
}
...
class DateField(name: String, default: java.lang.String = "0000-00-00") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case l: java.lang.Long => l.toString
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be java.lang.String or Long.")
  }
}
...
class BinaryField(name: String, default: Array[Byte] = new Array[Byte](0)) extends ElasticsearchField[Array[Byte]](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be Array[Byte]")
  }
}
...
class JavaStringField(name: String, default: String = "") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => "\"" + StringEscapeUtils.escapeJava(o.toString()) + "\""
  }
}
...
class HTMLStringField(name: String, default: String = "") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case _ => "\"" + StringEscapeUtils.escapeHtml4(o.toString()) + "\""
  }
}
...
class RangeField[T](name: String, default: String = "") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case (from: java.lang.Long, to: java.lang.Long) => {
      val ti = o.asInstanceOf[(Long, Long)]
      s"""{"gte": ${from}, "lte": ${to}}"""
    }
    ...
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be (Integer, Integer), (Long, Long), (Float, Float) or (String, String).")
  }
}
...
class ArrayField(name: String, default: String = "[]") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    case null => "null"
    case s: String => {
      JSON.parseRaw(s).getOrElse(null) match {
        case _: JSONArray => s
        case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be JSON Array in String form.")
      }
    }
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be JSON Array in String form.")
  }
...
class ObjectField(name: String, default: String = "{}") extends ElasticsearchField[String](name, default) {
  override def transform(o: AnyRef): String = o match {
    ...
    case s: String => {
      JSON.parseRaw(s).getOrElse(null) match {
        case _: JSONObject => s
        case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be JSON Object in String form.")
      }
    }
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be JSON Object in String form.")
  }
