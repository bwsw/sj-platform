  ...
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case e: String => {
      if(choices.contains(e)) {
        ...
        throw new IncompatibleTypeException(s"Object ${o} has incompatible value. Must include the one from choices ${choices} attribute.")
    }
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be Set[String].")
  }
}
  ...
  override def transform(o: AnyRef): (PreparedStatement, Int) => Unit = o match {
    ...
    case sc: Set[_] => {
      ...
      if(s.subsetOf(choices))
        ...
        throw new IncompatibleTypeException(s"Object ${o} has incompatible value. Must be a subset of choices ${choices} attribute.")
    }
    case _ => throw new IncompatibleTypeException(s"Object ${o} has incompatible type ${o.getClass}. Must be Set[String].")
  }
}
